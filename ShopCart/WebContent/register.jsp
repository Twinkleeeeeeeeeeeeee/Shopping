<%@page import="com.briup.mapper.RegisterMapper"%>
...
<html>
	<head>
		<jsp:useBean id="user" class="com.briup.dao.MyBatisSqlSessionFactory"></jsp:useBean>
		<jsp:useBean id="register" class="com.briup.service.Register"></jsp:useBean>
		<jsp:useBean id="allUser" class="com.briup.service.JSPTest"></jsp:useBean>
		...
		<script type="text/javascript">
			function checkName(){
				if(document.getElementById('name').value == "<%=register%>"){
					
					document.getElementById('usable').innerHTML='用户名可以用';
				}else{
					document.getElementById('usable').innerHTML='用户名不可用';
				}
			}
		</script>
...
<form method="post" name="reg" action="Register">
	<table cellpadding="3" cellspacing="1" align="center" class="tableborder1" id="table1">
		...
		<tr>
			...
			<input maxLength="8" size="32" name="userid" id="name" style="font-family: Tahoma,Verdana,宋体; font-size: 12px; line-height: 15px; color: #000000">
			<font color="#FF0000">*</font>
			<input type="button" value="检查用户名是否可用" onclick="checkName()"></input>
			<div id="usable" style="front-color: red"></div>
